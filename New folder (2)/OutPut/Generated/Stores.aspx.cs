...
public partial class admin_pages_Stores : System.Web.UI.Page
{	
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             Stores m_Stores = new Stores();
            m_Stores.StoreId = System.Byte.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_Stores.Delete();
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_Stores.StoreId = System.Byte.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_Stores.Delete();
                    }
                }
            }           
