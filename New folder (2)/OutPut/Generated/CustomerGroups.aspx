<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="CustomerGroups.aspx.cs" Inherits="admin_pages_CustomerGroups" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="CustomerGroupsEdit.aspx" title="Thêm mới " class="themmoi popup" > 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("CustomerGroupId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="CustomerGroupId">  
                         ...
                         <asp:TemplateField HeaderText="CustomerGroupName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltCustomerGroupName" runat="server" EnableViewState="false" Text='<%# Eval("CustomerGroupName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="CustomerGroupDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltCustomerGroupDesc" runat="server" EnableViewState="false" Text='<%# Eval("CustomerGroupDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='CustomerGroupsEdit.aspx?id=<%# Eval("CustomerGroupId") %>' class="iconadmsua popup" ></a>
