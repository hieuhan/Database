...
public partial class admin_pages_Supplier : System.Web.UI.Page
{	
    ...
    private void ShowGrid()
	{
        try
		{
            ...
            m_Supplier.SupplieName = txtSearch.Text;          
            string DateFrom = txtDateFrom.Text;
            string DateTo = txtDateTo.Text;
            int RowCount = 0;
            List<Supplier>  l_Supplier = m_Supplier.GetPage("", "", ddlOrderBy.SelectedValue, m_grid.PageSize, CustomPaging.PageIndex - 1, ref RowCount);
        
            m_grid.DataSource = l_Supplier;
            m_grid.DataBind();
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             Supplier m_Supplier = new Supplier();
            m_Supplier.SupplierId = System.Int32.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_Supplier.Delete();
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_Supplier.SupplierId = System.Int32.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_Supplier.Delete();
                    }
                }
            }           
