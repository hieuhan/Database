<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="SectionErrorType.aspx.cs" Inherits="admin_pages_SectionErrorType" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="SectionErrorTypeEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="SectionErrorTypeId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("SectionErrorTypeId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="SectionErrorTypeId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSectionErrorTypeId" runat="server" EnableViewState="false" Text='<%# Eval("SectionErrorTypeId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="SectionErrorTypeName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSectionErrorTypeName" runat="server" EnableViewState="false" Text='<%# Eval("SectionErrorTypeName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="SectionErrorTypeDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSectionErrorTypeDesc" runat="server" EnableViewState="false" Text='<%# Eval("SectionErrorTypeDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="ErrorCount">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltErrorCount" runat="server" EnableViewState="false" Text='<%# Eval("ErrorCount").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='SectionErrorTypeEdit.aspx?id=<%# Eval("SectionErrorTypeId") %>' class="iconadmsua popup" ></a>
