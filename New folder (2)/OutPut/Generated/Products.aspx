<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Products.aspx.cs" Inherits="admin_pages_Products" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="ProductsEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="ProductId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("ProductId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="ProductId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltProductId" runat="server" EnableViewState="false" Text='<%# Eval("ProductId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="ProductName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltProductName" runat="server" EnableViewState="false" Text='<%# Eval("ProductName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="ImagePath">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltImagePath" runat="server" EnableViewState="false" Text='<%# Eval("ImagePath") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="ManufacturerId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltManufacturerId" runat="server" EnableViewState="false" Text='<%# Eval("ManufacturerId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="UnitId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUnitId" runat="server" EnableViewState="false" Text='<%# Eval("UnitId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ProductGroupId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltProductGroupId" runat="server" EnableViewState="false" Text='<%# Eval("ProductGroupId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ProductTypeId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltProductTypeId" runat="server" EnableViewState="false" Text='<%# Eval("ProductTypeId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="OriginId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltOriginId" runat="server" EnableViewState="false" Text='<%# Eval("OriginId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="WarrantyId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltWarrantyId" runat="server" EnableViewState="false" Text='<%# Eval("WarrantyId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="StatusId">  
                         ...
                         <asp:TemplateField HeaderText="ProductContent">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltProductContent" runat="server" EnableViewState="false" Text='<%# Eval("ProductContent") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="UpdateUserId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUpdateUserId" runat="server" EnableViewState="false" Text='<%# Eval("UpdateUserId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='ProductsEdit.aspx?id=<%# Eval("ProductId") %>' class="iconadmsua popup" ></a>
