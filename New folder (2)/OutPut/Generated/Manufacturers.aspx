<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Manufacturers.aspx.cs" Inherits="admin_pages_Manufacturers" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="ManufacturersEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="ManufacturerId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("ManufacturerId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="ManufacturerId">  
                         ...
                         <asp:TemplateField HeaderText="ManufacturerName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltManufacturerName" runat="server" EnableViewState="false" Text='<%# Eval("ManufacturerName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="ManufacturerDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltManufacturerDesc" runat="server" EnableViewState="false" Text='<%# Eval("ManufacturerDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='ManufacturersEdit.aspx?id=<%# Eval("ManufacturerId") %>' class="iconadmsua popup" ></a>
