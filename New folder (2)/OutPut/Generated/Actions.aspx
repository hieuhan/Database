<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Actions.aspx.cs" Inherits="admin_pages_Actions" Title="" %>
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
            ...
            <table cellpadding="3" cellspacing="3" style="width: 100%;">
                <tr>
                    ...
                    <asp:DropDownList onselectedindexchanged="ddlActionStatusId_SelectedIndexChanged"  ID="ddlActionStatusId" DataTextField="ActionStatusDesc" DataValueField="ActionStatusId" 
        	...
        	<div class="chucnangright">
        		...
        		<a href="ActionsEdit.aspx" title="Thêm mới " class="themmoi popup" > 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("ActionId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="ActionId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltActionId" runat="server" EnableViewState="false" Text='<%# Eval("ActionId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="ActionName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltActionName" runat="server" EnableViewState="false" Text='<%# Eval("ActionName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="ActionDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltActionDesc" runat="server" EnableViewState="false" Text='<%# Eval("ActionDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="ParentActionId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltParentActionId" runat="server" EnableViewState="false" Text='<%# Eval("ParentActionId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Url">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUrl" runat="server" EnableViewState="false" Text='<%# Eval("Url") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="ActionStatusId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltActionStatusId" runat="server" EnableViewState="false" Text='<%# ActionStatuss.GetActionStatusName(System.Byte.Parse(Eval("ActionStatusId").ToString())) %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Display">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltDisplay" runat="server" EnableViewState="false" Text='<%# Eval("Display").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="TreeOrder">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltTreeOrder" runat="server" EnableViewState="false" Text='<%# Eval("TreeOrder").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='ActionsEdit.aspx?id=<%# Eval("ActionId") %>' class="iconadmsua popup" ></a>
