<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Units.aspx.cs" Inherits="admin_pages_Units" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="UnitsEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="UnitId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="UnitId">  
                         ...
                         <asp:TemplateField HeaderText="UnitName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUnitName" runat="server" EnableViewState="false" Text='<%# Eval("UnitName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="UnitDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUnitDesc" runat="server" EnableViewState="false" Text='<%# Eval("UnitDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='UnitsEdit.aspx?id=<%# Eval("UnitId") %>' class="iconadmsua popup" ></a>
