...
{	
    ...
    private void ShowGrid()
	{
        try
		{
            ...
            m_Roles.RoleName = txtSearch.Text;          
            string DateFrom = txtDateFrom.Text;
            string DateTo = txtDateTo.Text;
            int RowCount = 0;
            List<Roles>  l_Roles = m_Roles.GetPage("", "", ddlOrderBy.SelectedValue, m_grid.PageSize, CustomPaging.PageIndex - 1, ref RowCount);
        
            m_grid.DataSource = l_Roles;
            m_grid.DataBind();
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             Roles m_Roles = new Roles();
            m_Roles.RoleId = System.Byte.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_Roles.Delete();
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_Roles.RoleId = System.Byte.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_Roles.Delete();
                    }
                }
            }           
