<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="MediaGroups.aspx.cs" Inherits="admin_pages_MediaGroups" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="MediaGroupsEdit.aspx" title="Thêm mới " class="themmoi popup" > 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("MediaGroupId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="MediaGroupId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltMediaGroupId" runat="server" EnableViewState="false" Text='<%# Eval("MediaGroupId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="MediaGroupName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltMediaGroupName" runat="server" EnableViewState="false" Text='<%# Eval("MediaGroupName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="MediaGroupDesc">  
                            <ItemTemplate> 
                        ...
                        <asp:TemplateField HeaderText="ParentGroupId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltParentGroupId" runat="server" EnableViewState="false" Text='<%# Eval("ParentGroupId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='MediaGroupsEdit.aspx?id=<%# Eval("MediaGroupId") %>' class="iconadmsua popup" ></a>
