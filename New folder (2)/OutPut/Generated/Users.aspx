<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Users.aspx.cs" Inherits="admin_pages_Users" Title="" %>
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
            ...
            <table cellpadding="3" cellspacing="3" style="width: 100%;">
                <tr>
                    ...
                    <asp:DropDownList onselectedindexchanged="ddlUserStatusId_SelectedIndexChanged"  ID="ddlUserStatusId" DataTextField="UserStatusDesc" DataValueField="UserStatusId" 
                ...
                <tr>
                    ...
                    <td style="width:260px"> 
                    <asp:DropDownList onselectedindexchanged="ddlUserTypeId_SelectedIndexChanged"  ID="ddlUserTypeId" DataTextField="UserTypeDesc" DataValueField="UserTypeId" 
                    CssClass="userselect" runat="server" AutoPostBack="True">
                    </asp:DropDownList>
                    </td>
                    <td style="width:90px; white-space:nowrap;">
        	...
        	<div class="chucnangright">
        		...
        		<a href="UsersEdit.aspx" title="Thêm mới " class="themmoi popup" > 
                ...
                <asp:GridView ID="m_grid" DataKeyNames="UserId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="UserId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUserId" runat="server" EnableViewState="false" Text='<%# Eval("UserId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="UserName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUserName" runat="server" EnableViewState="false" Text='<%# Eval("UserName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="Password">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltPassword" runat="server" EnableViewState="false" Text='<%# Eval("Password") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="UserStatusId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUserStatusId" runat="server" EnableViewState="false" Text='<%# UserStatuss.GetUserStatusName(System.Byte.Parse(Eval("UserStatusId").ToString())) %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="UserTypeId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltUserTypeId" runat="server" EnableViewState="false" Text='<%# UserTypes.GetUserTypeName(System.Byte.Parse(Eval("UserTypeId").ToString())) %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="DefaultActionId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltDefaultActionId" runat="server" EnableViewState="false" Text='<%# Eval("DefaultActionId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                       <asp:TemplateField HeaderText="BirthDay">  
                            <ItemTemplate>  
                             <asp:Literal ID="ltBirthDay" runat="server" EnableViewState="false" Text='<%# String.Format("{0:dd/MM/yyyy}", Eval("BirthDay")) %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='UsersEdit.aspx?id=<%# Eval("UserId") %>' class="iconadmsua popup" ></a>
