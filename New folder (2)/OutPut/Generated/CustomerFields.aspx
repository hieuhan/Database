<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="CustomerFields.aspx.cs" Inherits="admin_pages_CustomerFields" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="CustomerFieldsEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="CustomerFieldId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("CustomerFieldId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="CustomerFieldId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltCustomerFieldId" runat="server" EnableViewState="false" Text='<%# Eval("CustomerFieldId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="FieldId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltFieldId" runat="server" EnableViewState="false" Text='<%# Eval("FieldId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="DocGroupId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltDocGroupId" runat="server" EnableViewState="false" Text='<%# Eval("DocGroupId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='CustomerFieldsEdit.aspx?id=<%# Eval("CustomerFieldId") %>' class="iconadmsua popup" ></a>
