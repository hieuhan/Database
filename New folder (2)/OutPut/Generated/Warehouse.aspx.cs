...
public partial class admin_pages_Warehouse : System.Web.UI.Page
{	
    ...
    private void ShowGrid()
	{
        try
		{
            ...
            m_Warehouse.WarehousName = txtSearch.Text;          
            string DateFrom = txtDateFrom.Text;
            string DateTo = txtDateTo.Text;
            int RowCount = 0;
            List<Warehouse>  l_Warehouse = m_Warehouse.GetPage("", "", ddlOrderBy.SelectedValue, m_grid.PageSize, CustomPaging.PageIndex - 1, ref RowCount);
        
            m_grid.DataSource = l_Warehouse;
            m_grid.DataBind();
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             Warehouse m_Warehouse = new Warehouse();
            m_Warehouse.WarehouseId = System.Byte.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_Warehouse.Delete();
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_Warehouse.WarehouseId = System.Byte.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_Warehouse.Delete();
                    }
                }
            }           
