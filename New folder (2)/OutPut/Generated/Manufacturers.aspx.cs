/* ********************************************************************************
'     Document    :  Manufacturers.aspx.cs
' ********************************************************************************/
using System;
...
public partial class admin_pages_Manufacturers : System.Web.UI.Page
{	
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             Manufacturers m_Manufacturers = new Manufacturers();
            m_Manufacturers.ManufacturerId = System.Int32.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_Manufacturers.Delete();
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_Manufacturers.ManufacturerId = System.Int32.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_Manufacturers.Delete();
                    }
                }
            }           
