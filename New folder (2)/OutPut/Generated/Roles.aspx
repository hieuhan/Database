<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Roles.aspx.cs" Inherits="admin_pages_Roles" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="RolesEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="RoleId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="RoleId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltRoleId" runat="server" EnableViewState="false" Text='<%# Eval("RoleId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="RoleName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltRoleName" runat="server" EnableViewState="false" Text='<%# Eval("RoleName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="RoleDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltRoleDesc" runat="server" EnableViewState="false" Text='<%# Eval("RoleDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='RolesEdit.aspx?id=<%# Eval("RoleId") %>' class="iconadmsua popup" ></a>
