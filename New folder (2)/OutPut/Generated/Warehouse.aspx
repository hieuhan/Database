<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Warehouse.aspx.cs" Inherits="admin_pages_Warehouse" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="WarehouseEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="WarehouseId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("WarehouseId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="WarehouseId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltWarehouseId" runat="server" EnableViewState="false" Text='<%# Eval("WarehouseId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="WarehouseName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltWarehouseName" runat="server" EnableViewState="false" Text='<%# Eval("WarehouseName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="WarehouseDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltWarehouseDesc" runat="server" EnableViewState="false" Text='<%# Eval("WarehouseDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="WarehouseStatus">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltWarehouseStatus" runat="server" EnableViewState="false" Text='<%# Eval("WarehouseStatus").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='WarehouseEdit.aspx?id=<%# Eval("WarehouseId") %>' class="iconadmsua popup" ></a>
