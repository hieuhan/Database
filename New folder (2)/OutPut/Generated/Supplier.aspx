<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Supplier.aspx.cs" Inherits="admin_pages_Supplier" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="SupplierEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="SupplierId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("SupplierId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="SupplierId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSupplierId" runat="server" EnableViewState="false" Text='<%# Eval("SupplierId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="SupplierName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSupplierName" runat="server" EnableViewState="false" Text='<%# Eval("SupplierName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="SupplierDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSupplierDesc" runat="server" EnableViewState="false" Text='<%# Eval("SupplierDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         ...
                         <asp:TemplateField HeaderText="Telephone">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltTelephone" runat="server" EnableViewState="false" Text='<%# Eval("Telephone") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="Comments">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltComments" runat="server" EnableViewState="false" Text='<%# Eval("Comments") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="ReviewStatusId">  
                            <ItemTemplate> 
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='SupplierEdit.aspx?id=<%# Eval("SupplierId") %>' class="iconadmsua popup" ></a>
