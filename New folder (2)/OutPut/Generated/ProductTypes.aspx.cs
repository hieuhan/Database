...
public partial class admin_pages_ProductTypes : System.Web.UI.Page
{	
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             ProductTypes m_ProductTypes = new ProductTypes();
            m_ProductTypes.ProductTypeId = System.Int16.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_ProductTypes.Delete();
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_ProductTypes.ProductTypeId = System.Int16.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_ProductTypes.Delete();
                    }
                }
            }           
