/* ********************************************************************************
'     Document    :  SectionDetailError.aspx.cs
' ********************************************************************************/
using System;
...
public partial class admin_pages_SectionDetailError : System.Web.UI.Page
{	
    ...
    private void ShowGrid()
	{
        try
		{
            ...
            m_SectionDetailError.SectionDetailErroName = txtSearch.Text;          
            string DateFrom = txtDateFrom.Text;
            string DateTo = txtDateTo.Text;
            int RowCount = 0;
            List<SectionDetailError>  l_SectionDetailError = m_SectionDetailError.GetPage("", "", ddlOrderBy.SelectedValue, m_grid.PageSize, CustomPaging.PageIndex - 1, ref RowCount);
        
            m_grid.DataSource = l_SectionDetailError;
            m_grid.DataBind();
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             SectionDetailError m_SectionDetailError = new SectionDetailError();
            m_SectionDetailError.SectionDetailErrorId = System.Int32.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_SectionDetailError.Delete();
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_SectionDetailError.SectionDetailErrorId = System.Int32.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_SectionDetailError.Delete();
                    }
                }
            }           
