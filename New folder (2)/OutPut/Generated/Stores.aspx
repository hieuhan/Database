<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Stores.aspx.cs" Inherits="admin_pages_Stores" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="StoresEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="StoreId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="StoreId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltStoreId" runat="server" EnableViewState="false" Text='<%# Eval("StoreId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="StoreName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltStoreName" runat="server" EnableViewState="false" Text='<%# Eval("StoreName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="StoreDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltStoreDesc" runat="server" EnableViewState="false" Text='<%# Eval("StoreDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='StoresEdit.aspx?id=<%# Eval("StoreId") %>' class="iconadmsua popup" ></a>
