<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="SectionError.aspx.cs" Inherits="admin_pages_SectionError" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="SectionErrorEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="SectionErrorId" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("SectionErrorId").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="SectionErrorId">  
                         ...
                         <asp:TemplateField HeaderText="SectionErrorName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSectionErrorName" runat="server" EnableViewState="false" Text='<%# Eval("SectionErrorName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="SectionErrorDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltSectionErrorDesc" runat="server" EnableViewState="false" Text='<%# Eval("SectionErrorDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="ErrorTypeStatusId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltErrorTypeStatusId" runat="server" EnableViewState="false" Text='<%# Eval("ErrorTypeStatusId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='SectionErrorEdit.aspx?id=<%# Eval("SectionErrorId") %>' class="iconadmsua popup" ></a>
