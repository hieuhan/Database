<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Suppliers.aspx.cs" Inherits="admin_pages_Suppliers" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="SuppliersEdit.aspx" title="Thêm mới " class="themmoi popup" > 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="SupplierId">  
                         ...
                         <asp:TemplateField HeaderText="Contact">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltContact" runat="server" EnableViewState="false" Text='<%# Eval("Contact") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='SuppliersEdit.aspx?id=<%# Eval("SupplierId") %>' class="iconadmsua popup" ></a>
