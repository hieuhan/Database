...
public partial class admin_pages_Actions : System.Web.UI.Page
{	
    ...
    private void ShowGrid()
	{
        try
		{
            ...
            m_Actions.ActionName = txtSearch.Text;          
            m_Actions.ActionStatusId = System.Byte.Parse(ddlActionStatusId.SelectedValue);
            string DateFrom = txtDateFrom.Text;
            string DateTo = txtDateTo.Text;
            int RowCount = 0;
            List<Actions>  l_Actions = m_Actions.GetPage("", "", ddlOrderBy.SelectedValue, m_grid.PageSize, CustomPaging.PageIndex - 1, ref RowCount);
    ...
    protected void m_grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
	{
		...
		{
             Actions m_Actions = new Actions();
            m_Actions.ActionId = System.Int16.Parse(m_grid.DataKeys[e.RowIndex].Value.ToString());
            m_Actions.Delete();
    ...
    protected void ddlActionStatusId_SelectedIndexChanged(object sender, System.EventArgs e)
	{       
        ShowGrid();
    }
        ...
        try
		{
            ...
            foreach(GridViewRow m_Row in m_grid.Rows)
			{
                ...
                if(chkAction != null)
				{
					...
					{
                        m_Actions.ActionId = System.Int16.Parse(m_grid.DataKeys[m_Row.RowIndex].Value.ToString());
                        m_Actions.Delete();
                    }
                }
            }           
