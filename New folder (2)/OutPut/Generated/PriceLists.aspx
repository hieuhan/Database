<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="PriceLists.aspx.cs" Inherits="admin_pages_PriceLists" Title="" %>
    ...
    <script type="text/javascript">
        ...
        <table cellpadding="3" cellspacing="3" class="tableBorder" style="width: 98%;" >
        	...
        	<div class="chucnangright">
        		...
        		<a href="PriceListsEdit.aspx" title="Thêm mới " class="themmoi popup" > 
            ...
            <div class="contenbangdulieu">
                <asp:GridView ID="m_grid" DataKeyNames="PriceList" runat="server" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            ...
                            <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                             ToolTip ='<%# Eval("PriceList").ToString() %>' >                                    
                            </asp:Label>
                            </ItemTemplate>      
                            <ItemStyle Width="5%" />            
                        </asp:TemplateField>        
                        <asp:TemplateField HeaderText="PriceList">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltPriceList" runat="server" EnableViewState="false" Text='<%# Eval("PriceList").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="PriceListName">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltPriceListName" runat="server" EnableViewState="false" Text='<%# Eval("PriceListName") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="PriceListDesc">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltPriceListDesc" runat="server" EnableViewState="false" Text='<%# Eval("PriceListDesc") %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="PriceListTypeId">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltPriceListTypeId" runat="server" EnableViewState="false" Text='<%# Eval("PriceListTypeId").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="IsDetail">  
                            <ItemTemplate> 
                                <asp:Literal ID="ltIsDetail" runat="server" EnableViewState="false" Text='<%# Eval("IsDetail").ToString() %>'></asp:Literal> 
                            </ItemTemplate>
                            <ItemStyle  HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            ...
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                                <a href='PriceListsEdit.aspx?id=<%# Eval("PriceList") %>' class="iconadmsua popup" ></a>
